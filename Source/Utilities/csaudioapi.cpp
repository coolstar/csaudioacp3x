...
NTSTATUS CCsAudioAcp3xHW::CSAudioAPIInit() {
	NTSTATUS status;
...
NTSTATUS CCsAudioAcp3xHW::CSAudioAPIDeinit() {
	if (this->CSAudioAPICallbackObj) {
...
void CCsAudioAcp3xHW::CSAudioAPICalled(CsAudioArg arg) {
...
CSAudioEndpointType CCsAudioAcp3xHW::GetCSAudioEndpoint(eDeviceType deviceType) {
	switch (deviceType) {
	case eSpeakerDevice:
...
eDeviceType CCsAudioAcp3xHW::GetDeviceType(CSAudioEndpointType endpointType) {
	switch (endpointType) {
